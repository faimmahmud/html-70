...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top luxury-nav" aria-label="Primary navigation">
...
<div class="container pt-3">
  <div class="alert alert-<?= e($flash['type']) ?> shadow-sm rounded-4 mb-0" role="status" aria-live="polite"><?= e($flash['message']) ?></div>
</div>
<?php endif; ?>
