    ...
    <div class="row g-4 align-items-stretch">
      ...
      <div class="col-lg-7">
        <div class="form-shell p-4 p-lg-5 reveal">
          ...
          <div id="bookingSuccess" class="alert alert-success d-none" role="status" aria-live="polite"></div>
          <div id="bookingError" class="alert alert-danger d-none" role="alert" aria-live="assertive"></div>
