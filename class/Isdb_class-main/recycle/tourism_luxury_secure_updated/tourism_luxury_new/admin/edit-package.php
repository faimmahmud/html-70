...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token($_POST['csrf_token'] ?? null)) {
        ...
        redirect(app_path('admin/edit-package.php?id=' . urlencode($id)));
    }
    ...
    $detailsSource = trim((string)($_POST['details'] ?? implode("\n", $pkg['details'] ?? [])));
    $pkg['details'] = array_values(array_filter(array_map('trim', preg_split('/\R/', $detailsSource))));
